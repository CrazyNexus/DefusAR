...
class Scene: SKScene {
    ...
    func displayMenu() {
        let logoLabel = SKLabelNode(fontNamed: "AvenierNext-Bold")
        ...
        let infoLabel = SKLabelNode(fontNamed: "AvenierNext-Bold")
        infoLabel.fontSize = 30.0
        infoLabel.text = "Tap to Play"
        infoLabel.horizontalAlignmentMode = .center
        infoLabel.verticalAlignmentMode = .center
        infoLabel.position = CGPoint(x: frame.midX, y: frame.midY - logoLabel.frame.size.height)
        infoLabel.name = "Menu"
        addChild(infoLabel)
        
        let highscoreLabel = SKLabelNode(fontNamed: "AvenierNext-Bold")
        highscoreLabel.fontSize = 30.0
        highscoreLabel.text = "Best: \(UserDefaults.standard.integer(forKey: "Highscore"))"
        highscoreLabel.verticalAlignmentMode = .center
        highscoreLabel.horizontalAlignmentMode = .center
        highscoreLabel.position = CGPoint(x: frame.midX, y: infoLabel.position.y - highscoreLabel.frame.size.height * 2.0)
